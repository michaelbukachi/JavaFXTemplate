            ...
            for (String headerValue : responseHeaders.get(headerKey)) {
                ...
                try {
                    ...
                    try {
                        ...
                        //System.out.println("CCC: "+headerValue);
...
//                        }
                    ...
                    for (HttpCookie cookie : cookies) {
                        ...
                        if (ports != null) {
                            ...
                            } else // Only store cookies with a port list
    ...
    private List<String> sortByPath(List<HttpCookie> cookies) {
        ...
        for (HttpCookie cookie : cookies) {
            ...
            // header; RFC 2965 requires a leading ${symbol_dollar}Version="1" string while Netscape
            // does not.
            // The workaround here is to add a ${symbol_dollar}Version="1" string in advance
            if (cookies.indexOf(cookie) == 0 && cookie.getVersion() > 0) {
                cookieHeader.add("${symbol_dollar}Version=${symbol_escape}"1${symbol_escape}"");
            }
